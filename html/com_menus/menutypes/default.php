...
?>
<style type="text/css">
.h-articles, .h-configurationmanager, .h-contacts, .h-newsfeeds, .h-callender, .h-wrapper, .h-search, .h-tags, .h-weblinks, .h-usersmanager, .h-akeebasubscriptions, .h-smartsearch {display: none;}
</style>

...
<div class="control-group">
      <div class="control-label"><label for="prefix"><?php echo JText::_( 'FLEXI_ADD_PREFIX' ); ?></label></div>
      <div class="controls">
<?php
...
<div class="control-group">
      <div class="control-label"><label for="suffix"><?php echo JText::_( 'FLEXI_ADD_SUFFIX' ); ?></label></div>
      <div class="controls">
...
<div class="control-group">
      <div class="control-label"><label><?php echo JText::_( 'FLEXI_COPIES_NR' ); ?></label></div>
      <div class="controls">
...
<fieldset class="form-horizontal" id="row_language">
   <div class="control-group">
      <div class="control-label">
<label for="language"><?php echo ($this->behaviour == 'translate' ? JText::_( 'NEW' )." " : '').JText::_( 'FLEXI_LANGUAGE' ); ?></label>
</div>
      <div class="controls">
...
<fieldset class="form-horizontal" id="row_type_id"><div class="control-group">
      <div class="control-label">
<label><?php echo JText::_( 'FLEXI_TYPE' ); ?></label>
</div>
      <div class="controls">
...
<fieldset class="form-horizontal" id="row_access"><div class="control-group">
      <div class="control-label">
<label><?php echo JText::_( 'FLEXI_ACCESS' ); ?></label>
</div>
      <div class="controls">
...
<fieldset class="form-horizontal" id="row_keeptags">
   ...
   <div class="control-group">
      <div class="control-label">
	<label><?php echo JText::_( 'FLEXI_KEEP_TAGS' ); ?></label>
</div>
      <div class="controls">
...
<fieldset class="form-horizontal" id="row_maincat">
   <div class="control-group">
      <div class="control-label">
<label><?php echo JText::_( 'FLEXI_MAIN_CATEGORY' ); ?></label>
</div>
      <div class="controls">
...
<fieldset class="form-horizontal" id="row_keepseccats">
   <div class="control-group">
      <div class="control-label">
	<label><?php echo JText::_( 'FLEXI_KEEP_SEC_CATS' ); ?></label>
	</div>
      <div class="controls">
		<div class="group-fcset fc_input_set">
...
<fieldset class="form-horizontal" id="row_seccats">
   <div class="control-group">
      <div class="control-label">
<label><?php echo JText::_( 'FLEXI_SECONDARY_CATEGORIES' ); ?></label>
</div>
      <div class="controls">

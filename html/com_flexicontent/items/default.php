...
<?php endif;?>
	...
	<div id="fc-managers-header">
		...
		<div class="fc-filter-head-box nowrap_box">
			...
			<div class="btn-group">
				...
				<div id="fc-mini-help_btn" class="<?php echo $out_class . ' ' . $this->tooltip_class; ?> hidden-phone" title="<?php echo JText::_('FLEXI_IMAN_ABOUT_ADDING_MORE_COLUMNS_AND_FILTERS'); ?>" onclick="fc_toggle_box_via_btn('fc-mini-help', this, 'btn-primary');" >
	...
	<thead>
		<tr>
			...
			<th class="col_notes left hidden-phone">
			</th>
		...
		<?php if ($useAssocs) : ?>
			<th class="col_assoc hideOnDemandClass left hidden-phone hidden-tablet">
	...
	<tbody <?php echo $ordering_draggable && $canOrder && $this->reOrderingActive ? 'id="sortable_fcitems"' : ''; ?> >
		...
		<?php endif; ?>
			...
			<td class="col_notes nowrap  hidden-phone">
				<?php
			...
			<?php if ($useAssocs) : ?>
			<td class="col_assoc hidden-phone hidden-tablet">
				<?php

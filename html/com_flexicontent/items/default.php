...
$btn_class = FLEXI_J30GE ? 'btn' : 'fc_button fcsimple btn';
...
$image_zoom = '<img src="templates/'.$template.'/images/flexi/monitor_go.png" width="16" height="16"  class="fc-padded-image '.$tip_class.'" alt="'.$_img_title.'" title="'.$_img_title.':: Click to display the frontend view of this item in a new browser window" />';
...
$catsinstate_tip = '<i class="icon-info hasTip" '.$_tooltip.'></i>';
...
$ordering_type_tip  = '<i data-placement="bottom" class="icon-comment '.$tip_class.'" alt="'.$_img_title.'" title="'.flexicontent_html::getToolTip($_img_title, $_img_title_desc, 0, 1).'"></i>';
$ord_grp = 1;
...
<div id="fc-filters-box" <?php if (!$this->count_filters) echo 'style="display:none;"'; ?> class="">
        ...
        <div class="smallx">
           ...
           <span class="break-sm"><label class="label"><small><?php echo JText::_( 'FLEXI_INCLUDE_SUBS' ); ?></small></label>
...
<div class="smallx">
<span class="boxy"><i class="icon-search"></i> <?php echo $this->lists['filter_state']; ?></span>
        
<span class="boxy"><i class="icon-book"></i> <?php echo $this->lists['filter_type']; ?></span>
        
<span class="boxy hlang"><i class="icon-comments-2"></i> <?php echo $this->lists['filter_lang']; ?></span>

<span class="boxy"><i class="icon-user"></i> <?php echo $this->lists['filter_authors']; ?></span>
        </div>
        </div>
...
<div class="smallx">
 ...
 <!--/filter_id-->
		...
		<div class="block-flat-s cat">
        <div class="smallx">
			<i class="icon-file"></i> <?php echo $this->lists['filter_fileid']; ?>
		</div>
</div>
		<?php endif; ?>
...
<a title="<?php echo JText::_('FLEXI_REMOVE_THIS_FILTER', true) ?>" onclick="delFilter('search');document.adminForm.submit();" class="red hasTip filterdel"><span class="icon-cancel"></span></a>
	   ...
	   <?php foreach($this->extra_fields as $field) :?>
		...
		<?php endforeach; ?>
			...
			<th width="<?php echo $this->CanOrder ? '' : ''; ?>" class="center hideOnDemandClass h400">
				<?php
		...
		<tr class="tra">
			...
			<?php if ( (FLEXI_FISH || FLEXI_J16GE) ): ?>
				<td class="col_lang hidden-tablet hidden-phone hlang"></td>
			<?php endif; ?>
			...
			<?php if ( $enable_translation_groups ) : ?>
				<td class="hidden-tablet hidden-phone hlang"></td>
			<?php endif; ?>
		...
		<tr>
			<td colspan="<?php echo $items_list_cols; ?>" class="white">
				<table class="no-border no-strip nohover white hidden-tablet hidden-phone">
					<tr>
						<td><img src="../administrator/templates/<?php echo $template; ?>/images/flexi/tick.png" width="16" height="16"  alt="<?php echo JText::_( 'FLEXI_PUBLISHED', true ); ?>" /></td>
						<td><?php echo JText::_( 'FLEXI_PUBLISHED_DESC' ); ?> <u><?php echo JText::_( 'FLEXI_PUBLISHED' ); ?></u></td>
						<td><img src="../administrator/templates/<?php echo $template; ?>/images/flexi/publish_g.png" width="16" height="16"  alt="<?php echo JText::_( 'FLEXI_IN_PROGRESS', true ); ?>" /></td>
						<td><?php echo JText::_( 'FLEXI_NOT_FINISHED_YET' ); ?> <u><?php echo JText::_( 'FLEXI_PUBLISHED' ); ?></u></td>
					</tr><tr>
						<td><img src="../administrator/templates/<?php echo $template; ?>/images/flexi/publish_x.png" width="16" height="16"  alt="<?php echo JText::_( 'FLEXI_UNPUBLISHED', true ); ?>" /></td>
						<td><?php echo JText::_( 'FLEXI_UNPUBLISHED_DESC' ); ?></td>
						<td><img src="../administrator/templates/<?php echo $template; ?>/images/flexi/publish_r.png" width="16" height="16"  alt="<?php echo JText::_( 'FLEXI_PENDING', true ); ?>" /></td>
						<td><?php echo JText::_( 'FLEXI_NEED_TO_BE_APPROVED' ); ?> <u><?php echo JText::_( 'FLEXI_UNPUBLISHED_DESC' ); ?></u></td>
						<td><img src="../administrator/templates/<?php echo $template; ?>/images/flexi/publish_y.png" width="16" height="16"  alt="<?php echo JText::_( 'FLEXI_TO_WRITE', true ); ?>" /></td>
						<td><?php echo JText::_( 'FLEXI_TO_WRITE_DESC' ); ?> <u><?php echo JText::_( 'FLEXI_UNPUBLISHED_DESC' ); ?></u></td>
					</tr><tr>
						<td><img src="../administrator/templates/<?php echo $template; ?>/images/flexi/archive.png" width="16" height="16"  alt="<?php echo JText::_( 'FLEXI_ARCHIVED', true ); ?>" /></td>
						<td><?php echo JText::_( 'FLEXI_ARCHIVED_STATE' ); ?> <u><?php echo JText::_( 'FLEXI_UNPUBLISHED_DESC' ); ?></u></td>
						<td><img src="../administrator/templates/<?php echo $template; ?>/images/flexi/trash.png" width="16" height="16"  alt="<?php echo JText::_( 'FLEXI_TRASHED', true ); ?>" /></td>
...
if (FLEXI_J16GE)
		...
		<?php if ( (FLEXI_FISH || FLEXI_J16GE) ): ?>
			<td class="hasTip col_lang center hidden-tablet hidden-phone hlang" title="<?php echo JText::_( 'FLEXI_LANGUAGE', true ).'::'.($row->lang=='*' ? JText::_("All") : $this->langs->{$row->lang}->name); ?>">
		...
		<?php endif; ?>
			...
			<?php if ($extra_img) : ?><img style='float:right;' src="templates/'.$template.'/images/flexi/<?php echo $extra_img;?>" width="16" height="16"  class="hasTip" alt="<?php echo $extra_alt; ?>" title="<?php echo $extra_alt; ?>" /><?php endif; ?>
			</td>

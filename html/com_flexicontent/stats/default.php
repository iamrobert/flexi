	...
	<div class="cssbox">
        ...
        <div class="table-responsive">
			<table class="no-border hover">
				<thead>
					<tr>
						<th class="text-left"><strong><?php echo JText::_( 'FLEXI_TYPE' ); ?></strong></th>
						<th class="center"><strong><?php echo JText::_( 'FLEXI_NUM' ); ?></strong></th>
					</tr>
				</thead>
	...
	<div class="cssbox">
        ...
        <div class="table-responsive">
			<table class="no-border hover">
				<thead>
					<tr>
						<th class="text-left"><strong><?php echo JText::_( 'FLEXI_TITLE' ); ?></strong></th>
						<th class="center"><strong><?php echo JText::_( 'FLEXI_HITS' ); ?></strong></th>
						<th class="text-right"><strong><?php echo JText::_( 'FLEXI_RATING' ); ?></strong></th>
					</tr>
				</thead>
				<tbody class="no-border">
					<?php
		...
		<div class="cssbox_body">
			<table class="no-border hover">
				<thead>
					<tr>
						<th class="text-left"><strong><?php echo JText::_( 'FLEXI_TITLE' ); ?></strong></th>
						<th class="center"><strong><?php echo JText::_( 'FLEXI_RATING' ); ?></strong></th>
					</tr>
				</thead>
				<tbody class="no-border">
				<?php
	...
	<div class="cssbox">
		...
		<div class="cssbox_body">
			<table class="no-border hover">
				<thead>
					<tr>
						<th class="text-left"><?php echo JText::_( 'FLEXI_TITLE' ); ?></th>
						<th class="center"><?php echo JText::_( 'FLEXI_RATING' ); ?></th>
					</tr>
				</thead>
				<tbody class="no-border">
					<?php
	...
	<div class="cssbox">
		...
		<div class="cssbox_body">
			<table class="no-border hover">
				<thead>
					<tr>
						<th class="text-left"><?php echo JText::_( 'FLEXI_USER' ); ?></th>

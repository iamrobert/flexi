		...
		<form action="index.php?option=<?php echo $this->option; ?>&amp;view=<?php echo $this->view; ?>&amp;layout=<?php echo $this->layout; ?>&amp;field=<?php echo $this->fieldid?>" method="post" name="adminForm" id="adminForm">
			...
			<?php endif; ?>
				...
				<div class="nowrap_box" style="margin: 6px 0;">
					...
					<div id="fc-mini-help_btn" class=<?php echo $this->btn_sm_class . ' ' . $out_class; ?> hidden-phone" onclick="fc_toggle_box_via_btn('fc-mini-help', this, 'btn-primary');" >
				...
				<div class= "fc-iblock hidden-phone" style="margin: 8px 6px;">
    		...
    		<tr>
				...
				<?php if ($this->folder_mode) : ?>
					<th class="col_size center hideOnDemandClass hidden-phone"><?php echo JText::_('FLEXI_SIZE'); ?></th>
				<?php else : ?>
					<th class="col_size center hideOnDemandClass hidden-phone"><?php echo JHtml::_('grid.sort', 'FLEXI_SIZE', 'a.size', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
				<?php endif; ?>
			...
			<tbody>
				...
				<?php endif; ?>
					...
					<td class="col_size small center hidden-phone"><?php echo $row->size; ?></td>
...
<!--   col 4-->
		<?php if (!$isFilesElement) : ?>
			...
			<div class="tabbertab" id="fileman_info_tab" data-icon-class="icon-info fc-icon-gray">
				<h3 class="tabberheading hasTooltip  hidden-phone hidden-tablet" data-placement="bottom" title="<?php echo JText::_( 'FLEXI_FILEMAN_INFO_DESC' ); ?>"> <?php echo JText::_( 'FLEXI_FILEMAN_INFO' ); ?> </h3>
				<div id="why_box" class="info-box  hidden-phone hidden-tablet">

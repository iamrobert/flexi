...
<table class="adminform">
	...
	<thead>
		<tr>
			...
			<?php endif; ?>
			<th width="1%" class="nowrap"><?php echo JText::_( 'FLEXI_STATE' ); ?></th>
	...
	<tbody>
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td class="center" class="col_type">
				<?php echo $row->type_name; ?>
			</td>
			
		<?php if ( (FLEXI_FISH || FLEXI_J16GE) ): ?>
			<td class="center hasTip col_lang" title="<?php echo JText::_( 'FLEXI_LANGUAGE' ).'::'.($row->lang=='*' ? JText::_("All") : (!empty($row->lang) ? $this->langs->{$row->lang}->name : '')); ?>">
		...
		<?php endif; ?>
			...
			<td class="center">
				<?php if ($img) : ?>
					<img src="<?php  echo $app->isAdmin() ? "../" : ""; ?>administrator/templates/flexi/images/flexi/<?php echo $img;?>" width="16" height="16" border="0" alt="<?php echo $alt; ?>" title="<?php echo $alt; ?>" />
				<?php endif; ?>
			</td>

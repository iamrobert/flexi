...
<div class="flexicontent" id="flexicontent">
  <form action="index.php" method="post" class="form-validate form-horizontal" name="adminForm" id="adminForm" class="form-horizontal">
        ...
        <div class="block-flat fc-form-tbl">
          ...
          <div class="control-group">
            ...
            <div class="controls"> <?php echo $form->getInput('name'); ?>
              ...
              <span class="fc-info fc-nobgimage fc-mssg fc-mssg-inline"><?php echo JText::_('FLEXI_NOTES'); ?>: <span class="<?php echo $tip_class; ?>" data-placement="bottom" title="<?php echo flexicontent_html::getToolTip(JText::_('FLEXI_NOTES'), JText::sprintf('FLEXI_CORE_FIELDS_CUSTOMIZATION', 'text', '<b>'.JText::_('FLEXI_DESCRIPTION').'</b>', 'text'), 0, 1); ?>"> <?php echo $hint_image; ?> </span> </span>
          ...
          <div class="control-group">
            ...
            <div class="controls"> <span class="badge badge-info"><?php echo $form->getValue("name"); ?></span>
              ...
              <span class="fc-info fc-nobgimage fc-mssg fc-mssg-inline"><?php echo JText::_('FLEXI_NOTES'); ?>: <span class="<?php echo $tip_class; ?>" data-placement="bottom" title="<?php echo flexicontent_html::getToolTip(JText::_('FLEXI_NOTES'), JText::sprintf('FLEXI_FIELD_CUSTOMIZE_PER_CONTENT_TYPE', 'textarea', 'text', 'text'), 0, 1); ?>"> <?php echo $hint_image; ?> </span> </span>
				...
				if ($field_type) foreach ($fieldSets as $name => $fieldSet)
				{
					...
					<div class="tabbertab" id="fcform_tabset_<?php echo $name; ?>_tab" <?php echo $icon; ?> <?php echo $prepend; ?>>
						...
						<?php foreach ($form->getFieldset($name) as $field) {
							...
							echo '<fieldset class="control-group'.($i ? '' : ' fc-nomargin').' '.($_depends ? ' '.$_depends : '').'" id="'.$field->id.'-container" >' .'<div class="control-label">'. $field->label .'</div><div class="controls">'. $field->input .'</div>'. '</fieldset>' . "\n";

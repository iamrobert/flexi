	...
	window.addEvent('domready', function(){
		$('import').addEvent('click', function(e) {
			...
			if (MooTools.version>="1.2.4") {
				$('import-log').set('html','<img src="templates/flexi/images/flexi/ajax-loader.gif" class="center">');
				new Request.HTML({
					url: url,
					method: 'get',
					update: $('import-log')
				...
				$('import-log').setHTML('<p class="centerimg"><img src="templates/flexi/images/flexi/ajax-loader.gif" class="center"></p>');

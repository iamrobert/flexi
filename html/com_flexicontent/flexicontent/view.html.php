...
class FlexicontentViewFlexicontent extends JViewLegacy
{
	...
	function display( $tpl = null )
	{
		...
		$css =	'.install-ok { background: url(administrator/templates/flexi/images/flexi/accept.png) 0% 50% no-repeat transparent; padding:1px 0; width: 20px; height:16px; display:block; }
				 .install-notok { background: url(administrator/templates/flexi/images/flexi/delete.png) 0% 50% no-repeat transparent; padding:1px 0; width: 20px; height:16px; display:block; float:left;}';		
		...
		<div style="float:<?php echo ($lang->isRTL()) ? 'right' : 'left'; ?>;">
			<div class="icon">
				...
				<?php
					...
					echo FLEXI_J16GE ?
						JHTML::image('administrator/templates/flexi/images/flexi/'.$image, $text) :
						JHTML::_('image.site', $image, '../administrator/templates/flexi/images/flexi/', NULL, NULL, $text) ;
				?>

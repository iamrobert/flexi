...
<div class="responsive-table">
  <table class="adminlist table no-border no-hover">
    <thead class="no-border">
      <tr>
        <th colspan="2"> <?php echo JText::_( 'FLEXI_VERSION' ); ?> </th>
      </tr>
    </thead>
...
<table class="adminlist table no-border no-hover">
  ...
  <tbody class="no-border-y">
    <tr>
      <td colspan="2" class="no-border-top"><?php
    ...
    <tr>
      <td width="33%"><?php echo JText::_( 'FLEXI_LATEST_VERSION' ).':'; ?></td>
      <td><span class="badge badge-success"><?php echo $this->check['version']; ?></span> &nbsp; <strong><?php echo JText::_( 'FLEXI_RELEASED_DATE' ); ?></strong>: <?php echo $this->check['released']; ?></td>
    </tr>
    <tr>
    <tr>
      <td><?php echo JText::_( 'FLEXI_INSTALLED_VERSION' ); ?></td>
      <td><span class="badge <?php echo $this->check['current']==-1 ? 'badge-warning' : ($this->check['current']==0 ? 'badge-success' : ''); ?>"><?php echo $this->check['current_version']; ?></span> &nbsp; <b><?php echo JText::_( 'FLEXI_RELEASED_DATE' ); ?></b>:
        <?php
        try {
          $timezone = 'UTC';
          $dateformat = 'Y-m-d';

...
<div class="row-fluid">
   ...
   <div class="span6 wid100 dashacc">
		...
		elseif (!$skip_sliders && $config_saved) :
			...
			echo JHtml::_('bootstrap.startAccordion', 'fc-dash-sliders', array('active' => '', 'parent' =>'fc-dash-sliders'));
...
<?php  ?>
   ...
   <div class="span6 wid100">
      ...
      echo JHtml::_('bootstrap.startAccordion', 'right-accordion-1', array('active' => 'slide1_id', 'parent' => 'right-accordion-1'));

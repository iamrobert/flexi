    ...
    <div id="j-main-container">
      ...
      <div class="row-fluid">
		...
		if ($this->dopostinstall) {
            ...
            <fieldset class="fc-board-set">
              <legend class="fc-board-header"><?php echo JText::_( 'FLEXI_NAV_SD_TYPES_N_FIELDS' );?></legend>
              <div class="fc-board-set-inner">
                <?php
			$add_sep = false;
            ...
            <?php endif; ?>
            <?php if (empty($skip_contentviewing_fieldset)): ?>
            <fieldset class="fc-board-set">
              <legend class="fc-board-header"><?php echo JText::_( 'FLEXI_NAV_SD_CONTENT_VIEWING' );?></legend>
              <div class="fc-board-set-inner">
                <?php
			$add_sep = false;
            ...
            <fieldset class="fc-board-set">
              <legend class="fc-board-header"><?php echo JText::_( 'FLEXI_NAV_SD_USERS_N_GROUPS' );?></legend>
              <div class="fc-board-set-inner">
                <?php
            ...
            <fieldset class="fc-board-set">
              <legend class="fc-board-header"><?php echo JText::_( 'FLEXI_NAV_SD_EXPERT_USAGE' );?></legend>
              <div class="fc-board-set-inner">
                <?php
			$add_sep = false;
            ...
            <fieldset class="fc-board-set">
              <legend class="fc-board-header"><?php echo JText::_( 'FLEXI_HELP' );?></legend>
              <div class="fc-board-set-inner">
                <?php
		...
		?>
          ...
          <div class="credits"> <?php echo !$hide_fc_license_credits ? '<fieldset class="fc-board-set"><legend class="fc-board-header-content-editing">'.JText::_( 'About FLEXIcontent' ).'</legend>' : ''; ?>
            <div class="fc-board-set-inner">
              <?php
					$logo_style = ';';
              ...
              <p class="center"> <span class="label label-info <?php echo $tooltip_class;?>" title="Core Developer">Marvelic Engine</span> <span class="label <?php echo $tooltip_class;?>" title="Core Developer">Suriya Kaewmungmuang</span><br>
                <a class="<?php echo $btn_class.(FLEXI_J30GE ? ' btn-small ' : ' fcsmall fcsimple ').$tooltip_class;?>"  href="http://www.marvelic.co.th" target="_blank" title="<?php echo flexicontent_html::getToolTip("Marvelic Engine", "Marvelic Engine is a Joomla consultancy based in Bangkok, Thailand. Support services include consulting, Joomla implementation, training, and custom extensions development.", 0, 1); ?>"> marvelic.co.th </a> </p>
              <p class="center"> <span class="label <?php echo $tooltip_class;?>" title="Core Developer">Yannick Berges</span><br>
                <a class="<?php echo $btn_class.(FLEXI_J30GE ? ' btn-small ' : ' fcsmall fcsimple ').$tooltip_class;?>"  href="http://com3elles.com/" target="_blank" title="<?php echo flexicontent_html::getToolTip("Com'3Elles", "Com'3Elles, agence de communication, conseil et formations", 0, 1); ?>"> com3elles.com </a> </span> </p>
              <p class="center"> <span class="label <?php echo $tooltip_class;?>" title="Developer / Contributor">Ruben Reyes</span><br/>
                <a class="<?php echo $btn_class.(FLEXI_J30GE ? ' btn-small ' : ' fcsmall fcsimple ').$tooltip_class;?>"  href="http://www.lyquix.com" target="_blank" title="<?php echo flexicontent_html::getToolTip("Lyquix", "Lyquix - Philadelphia Marketing, Advertising, Web Design and Development Agency", 0, 1); ?>"> lyquix.com </a> </span></p>
            </div>
            <?php echo !$hide_fc_license_credits ? '</fieldset>' : ''; ?> </div>

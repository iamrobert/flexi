...
<?php
				...
				if ($this->dopostinstall) {
                    ...
                    <h3><?php echo JText::_( 'FLEXI_NAV_SD_CONTENT_EDITING' );?></h3>
                    <?php
				...
				?><div class="m20b"></div>
                               ...
                               <h3><?php echo JText::_( 'FLEXI_NAV_SD_TYPES_N_FIELDS' );?></h3> 
                    ...
                    <h3><?php echo JText::_( 'FLEXI_NAV_SD_CONTENT_VIEWING' );?></h3>
					<?php
					...
					?><div class="m20b"></div>
					<h3><?php echo JText::_( 'FLEXI_NAV_SD_USERS_N_GROUPS' );?></h3>
                    ...
                    <h3><?php echo JText::_( 'FLEXI_NAV_SD_EXPERT_USAGE' );?></h3>
  ...
  <!--SIDE-->
    <div id="accordion3" class="panel-group accordion accordion-semi">
			...
			echo "<a href='$show_all_link' class=\"show-all\">Show All</a>";
			?>

...
$revertimage  = JHTML::image ( 'administrator/templates/flexi/images/flexi/arrow_rotate_anticlockwise.png', JText::_( 'FLEXI_REVERT' ) );
$viewimage    = JHTML::image ( 'administrator/templates/flexi/images/flexi/magnifier.png', JText::_( 'FLEXI_VIEW' ) );
$commentimage = JHTML::image ( 'administrator/templates/flexi/images/flexi/comment.png', JText::_( 'FLEXI_COMMENT' ) );
...
<div class="form-horizontal">
 <div class="form-inline m10x">
			...
			?>
                      <label id="jform_title-lbl" for="jform_title" <?php echo $label_tooltip; ?> > <?php echo $field->label; //JText::_( 'FLEXI_TITLE' ); ?> </label>
                      ...
                      <div class="controls">
                        ...
                        <?php
								...
								?>
                        <input class="fc_form_title fcfield_textval required span8 w100" type="text" id="<?php echo $ff_id; ?>" name="<?php echo $ff_name; ?>" value="<?php echo @$t->fields->title->value; ?>" maxlength="254" aria-required="true" aria-invalid="true" />
                        <?php endif; ?>
                        <?php endforeach; ?>
                        <?php else : ?>
                        <?php echo $this->form->getInput('title');?>
			...
			if ( $this->perms['canpublish'] ) : ?>
                        <div class="container_fcfield container_fcfield_id_10 container_fcfield_name_state fcdualline" id="container_fcfield_10" > <?php echo $this->lists['state']; ?>
                          ...
                          <i class="icon-info hasTip m3l" title="<?php echo htmlspecialchars(JText::_( 'FLEXI_NOTES' ), ENT_COMPAT, 'UTF-8'); ?>::<?php echo htmlspecialchars(JText::_( 'FLEXI_TYPE_CHANGE_WARNING' ), ENT_COMPAT, 'UTF-8');?>"></i> </div>
                        <?php else :
				echo $this->published;
		...
		?>
			...
			?>
                  ...
                  <!--BASIC-->
                  <hr>
                  <h3><i class="icon-folder m20r"></i><?php echo JText::_( 'FLEXI_CATEGORIES' ); ?></h3>
                  ...
                  <?php
					...
					$label_tooltip = $field->description ? 'class="control-label hasTip flexi_label" title="'.htmlspecialchars($field->description, ENT_COMPAT, 'UTF-8').'"' : 'class="control-label"';
				?>
                  <hr>
                  <div class="form-inline htags">
                    <div class="control-group">
                      <label id="jform_tag-lbl" for="jform_tag" <?php echo $label_tooltip; ?> > <?php echo $field->label; ?>
                  ...
                  <div class="hlang">
                    <hr>
                    <h3><i class="icon-comments-2 m20r"></i><?php echo JText::_( 'FLEXI_LANGUAGE' ); ?></h3>
                    <div class="form-inline">
                      <div class="control-group">
                        <label class="control-label"> <?php echo $this->form->getLabel('language'); ?> </label>
                        <div class="controls">
...
//$tabCnt[$tabSetCnt] = 0;
		...
		<fieldset class="panelform params_set">
         ...
         <div class="form-inline m10x hmetad">
                    <div class="control-group">
			...
			<div class="controls">
				...
				<?php endif; ?>
                    ...
                    <div class="form-inline m10x hkey">
                    <div class="control-group">
...
?>		
					<?php foreach ($this->form->getFieldset($name) as $field) : ?>
	                       <div class="form-inline m10x h-<?php echo $SetCnt++; ?>  ">
                        <div class="control-group">
						<?php echo $field->label; ?>
                        <div class="controls">
    ...
    <div id="collapseOne" class="accordion-body in collapse">
      <div class="panel-body form-horizontal">
		...
		<fieldset class="flexi_params fc_edit_container_full" style="<?php echo $hide_style; ?>" >
			...
			<div class="form-inline m10x"><div class="control-group"><?php echo $this->form->getLabel('created_by'); ?>
			<div class="controls"><?php echo $this->form->getInput('created_by'); ?></div></div></div>
			<?php /*endif;*/ ?>
			
			<?php if ($this->perms['editcreationdate']) : ?>
			<div class="form-inline m10x"><div class="control-group"><?php echo $this->form->getLabel('created'); ?>
			<div class="controls"><?php echo $this->form->getInput('created'); ?></div></div></div>
			<?php endif; ?>
			
			<div class="form-inline m10x"><div class="control-group"><?php echo $this->form->getLabel('created_by_alias'); ?>
			<div class="controls"><?php echo $this->form->getInput('created_by_alias'); ?></div></div></div>
			
			<div class="form-inline m10x"><div class="control-group"><?php echo $this->form->getLabel('publish_up'); ?>
			<div class="controls"><?php echo $this->form->getInput('publish_up'); ?></div></div></div>
			
			<div class="form-inline m10x"><div class="control-group"><?php echo $this->form->getLabel('publish_down'); ?>
			<div class="controls"><?php echo $this->form->getInput('publish_down'); ?></div></div></div>
			
			<div class="form-inline m10x"><div class="control-group"><?php echo $this->form->getLabel('access'); ?>
...
<!--PANEL2--> 
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="accordion-body collapsed collapse">
     ...
     <!--  VERSIONING-->
		...
		?>
		<table class="responsive no-strip ">
		<?php
		if ( $this->row->id ) {
		?>
        <tbody>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title"><a class="collapsed collapsed" data-toggle="collapse" data-parent="#accordion2" href="#collapse3">
       <i class="fa icon-arrow-right"></i> <i class="icon-clock"></i> Revisions</a></h4>
    </div>
    <div id="collapse3" class="accordion-body collapsed collapse">
      <div class="panel-body form-horizontal">

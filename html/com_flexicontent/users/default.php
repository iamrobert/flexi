...
<div id="fc-filters-header"> <span class="btn-wrapper input-append fc-filter"><span class="filter-search btn-group">
	...
	<table id="adminListTableFCusers" class="adminlist fcmanlist table no-border hover">
	<thead>
          <tr class="header">
			...
			<th class="hideOnDemandClass center hidden-phone" nowrap="nowrap">
			...
			<th class="hideOnDemandClass left hidden-tablet hidden-phone">
		...
		<?php
			...
			for ($i=0, $n=count( $this->rows ); $i < $n; $i++)
			{
				...
				$img_pathx  = ''.JURI::base().'templates/'.$template.'/images/flexi/';
				
			
				$tick_img  = $img_pathx . 'tick.png';
				$block_img = $img_pathx . ($row->block ? 'publish_x.png' : 'tick.png');
			...
			<tr class="<?php echo "row$k"; ?>">
				<th class="center hidden-tablet hidden-phone">
				...
				<td class="center col_logged hidden-phone">
				...
				<td class="center col_itemscount  hidden-tablet hidden-phone">
					<?php echo $itemscount; ?>
				</td>
				<td class="center col_uploadssize  hidden-tablet hidden-phone">
				...
				<td nowrap="nowrap" class="center col_registered hidden-tablet hidden-phone">
					<?php echo $registered; ?>
				</td>
				<td nowrap="nowrap" class="center col_visited hidden-tablet hidden-phone">
					<?php echo $lvisit; ?>
				</td>

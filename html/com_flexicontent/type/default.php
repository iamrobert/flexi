...
<form action="index.php" method="post" name="adminForm" id="adminForm"  class="form-horizontal">
	...
	<div class="row-fluid  m20">
		<div class="span6 full_width_980">
			<div class="fc-form-tbl block-flat m10">
...
<div class="controls">
		...
		<div class="span6 full_width_980">
			...
			<span class="fc-info fc-nobgimage fc-mssg">
...
<?php
		...
		<div class="tabbertab" id="fcform_tabset_<?php echo $tabSetCnt; ?>_tab_<?php echo $tabCnt[$tabSetCnt]++; ?>" data-icon-class="icon-palette">
			...
			<div class="fc_tabset_inner">
				<?php
				echo '<span class="fc-info fc-nobgimage fc-mssg-inline">' . JText::_( 'FLEXI_PARAMETERS_LAYOUT_EXPLANATION' ) ;
				?>
				<br/>
				<ol>

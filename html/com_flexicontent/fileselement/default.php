...
<?php } ?>
			...
			<th width="1%" class="nowrap"><?php echo JText::_( 'FLEXI_PUBLISHED' ); ?></th>
...
<?php if (!$this->folder_mode) { ?>
			<th width="1%" class="nowrap"><?php echo JHTML::_('grid.sort', 'FLEXI_ID', 'f.id', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
<?php } ?>
		</tr>
...
<?php if ($this->folder_mode) { ?>
			<td>
				...
				<?php echo JHTML::image('administrator/templates/flexi/images/flexi/trash.png', JText::_('FLEXI_REMOVE') ); ?>
				</a>
			</td>
<?php } ?>
			<td class="center">
...
<?php if (!$this->folder_mode) { ?>
			<td class="center">
				<?php echo JHTML::image('administrator/templates/flexi/images/flexi/'. ($row->published ? 'tick.png' : 'publish_x.png'), JText::_('FLEXI_REMOVE') ); ?>
			</td>
<?php } ?>
...
<?php if (!$this->folder_mode) { ?>
   		...
   		?>
			<td class="center hasTip col_lang" title="<?php echo JText::_( 'FLEXI_LANGUAGE', true ).'::'.($row->language=='*' ? JText::_("All") : $this->langs->{$row->language}->name); ?>">

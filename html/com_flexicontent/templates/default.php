...
jQuery(document).ready(function() {
	jQuery('a.deletable-template').click(function( event ) {
		...
		el.html('<img src=\"administrator/templates/flexi/images/flexi/ajax-loader.gif\" align=\"center\">');
		jQuery.ajax({
			type: \"GET\",
...
<div class="table-responsive">               
	...
	<tbody>
		<?php
		$editlayout = JHTML::image ( 'administrator/templates/flexi/images/flexi/layout_edit.png', JText::_( 'FLEXI_EDIT_LAYOUT' ) );
		$noeditlayout = JHTML::image ( 'administrator/templates/flexi/images/flexi/layout_link.png', JText::_( 'FLEXI_NOEDIT_LAYOUT' ) );
		$copytmpl = JHTML::image ( 'administrator/templates/flexi/images/flexi/layout_add.png', JText::_( 'FLEXI_DUPLICATE' ) );
		$deltmpl = JHTML::image ( 'administrator/templates/flexi/images/flexi/layout_delete.png', JText::_( 'FLEXI_REMOVE' ) );
		$k = 0;
		$i = 1;

...
<head>
 ...
 <style type="text/css">
    .purple, .admin.com_flexicontent #content a, .fcsep_level1, dl.tabs dt span,
dl.tabs dt h3 a, #flexicontent ul.tabbernav li a, .pane-sliders .panel h3, .pane-sliders .title, .com_flexicontent .accordion .panel-heading a, .all i.icon-edit:before, .icon-edit:before, .admin.com_flexicontent #content .nav-tabs > li.active a:hover, .admin.com_flexicontent #content .nav-tabs > li.active a:hover i, .admin.com_flexicontent #content .nav-tabs > li.active a:hover i.icon-edit:before, #flexicontent fieldset legend {color: <?php echo $this->params->get('flexiColor'); ?>;}

#flexicontent ul.tabbernav li.tabberactive a, #flexicontent ul.tabbernav li.tabberactive a:hover, dl.tabs dt.open h3 a, dl.tabs dt h3 a  {color: <?php echo $this->params->get('flexiColor'); ?> !important;}

dl.tabs dt.open {
	border-top-color: <?php echo $this->params->get('flexiColor'); ?>;
	}
	#flexicontent ul.tabbernav li.tabberactive a, #flexicontent ul.tabbernav li.tabberactive a:hover {
		border-top-color: <?php echo $this->params->get('flexiColor'); ?>;}
.admin.com_flexicontent #content .accordion.accordion-semi .panel-heading a, #flexicontent form input.btn-primary:hover, #flexicontent form input.btn-primary:active, #flexicontent form input.btn-primary.active, #flexicontent form input.open .dropdown-toggle.btn-primary, .flexicontent button:not(.btn), .fc_button:not(.btn), .fc_buttons button:not(.btn), .flexi_buttons button:not(.btn) {

...
padding: 4px 6px;
	...
	.loginform .btn-primary.btn {
				background-color: <?php echo $this->params->get('buttonColor'); ?>;}
			<?php endif; ?>	
			
			<?php if ($this->params->get('buttonhoverColor')) : ?>	
		.loginform .btn-primary.btn:hover, .loginform .btn-primary.btn:active {
	background-color:<?php echo $this->params->get('buttonhoverColor'); ?>; }
	<?php endif; ?>	
	</style>
...
<body class="site <?php echo $option . " view-" . $view . " layout-" . $layout . " task-" . $task . " itemid-" . $itemid . " ";?> texture">
	<!-- Container -->
	<div class="container">
		<div id="content">
			<!-- Begin Content -->
			...
			<div id="element-box" class="login block-flat-login">

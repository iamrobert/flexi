...
{
    $this->addStyleDeclaration('.btn.btn-primary {
...
{
    $this->addStyleDeclaration('.btn.btn-primary:hover, .btn.btn-primary:focus  {
...
<body class="site <?php echo $option . ' view-' . $view . ' layout-' . $layout . ' task-' . $task . ' itemid-' . $itemid . ' '; ?>">
	...
	<div class="navbar<?php echo $color_is_light ? ' navbar-inverse' : ''; ?> navbar-fixed-bottom hidden-phone">
		...
		<a class="login-joomla hasTooltip" href="https://www.joomla.org" target="_blank"  rel="noopener noreferrer" title="<?php echo JHtml::_('tooltipText', 'TPL_IAMR_ISFREESOFTWARE'); ?>"><span class="icon-joomla"></span></a>
